...
export const Page = () => {
  ...
  const urls = useAsync(async () => {
    const v2 = { label: 'Metrics Dashboard API (OpenAPI v2)', key: 'openapi2', value: 'public/api-merged.json' };
    const v3 = { label: 'Metrics Dashboard API (OpenAPI v3)', key: 'openapi3', value: 'public/openapi3.json' };
        ...
        <NamespaceContext.Provider value={namespace.value}>
          <div style={{ backgroundColor: '#000', padding: '10px' }}>
            <Stack justifyContent={'space-between'}>
              <img height="40" src={metricsIconSvg} alt="Metrics Dashboard" />
              <Select
                options={urls.value}
