...
export class UnthemedDashboardRow extends Component<DashboardRowProps> {
  ...
  onUpdate = (title: string, repeat?: string | null, collapsedIcon?: string, rowGroup?: string) => {
    ...
    // Store collapsedIcon directly on the panel (persisted property)
    this.props.panel.setProperty('collapsedIcon', collapsedIcon || undefined);
    // Store rowGroup directly on the panel (persisted property)
    this.props.panel.setProperty('rowGroup', rowGroup || undefined);
  ...
  render() {
    ...
    // Support for collapsed icon/image via panel collapsedIcon property
    const collapsedIcon = this.props.panel.collapsedIcon;
    const displayTitle = collapsed && collapsedIcon ? (
      <span className={styles.collapsedIconWrapper}>
        <img src={collapsedIcon} alt={title} className={styles.collapsedIcon} />
      </span>
    ) : title;
        ...
        {canEdit && (
          <div className={styles.actions}>
            <RowOptionsButton
              ...
              collapsedIcon={this.props.panel.collapsedIcon}
              rowGroup={this.props.panel.rowGroup}
