...
const tablePanel = async () => {
  // Always use the new table panel with enhanced styling options
...
const imagePanel = async () => await import(/* webpackChunkName: "imagePanel" */ 'app/plugins/panel/image/module');
...
const controlPanel = async () =>
  await import(/* webpackChunkName: "controlPanel" */ 'app/plugins/panel/fluvio-control-panel/module');
...
const builtInPlugins: Record<string, System.Module | (() => Promise<System.Module>)> = {
  ...
  'core:plugin/fluvio-control-panel': controlPanel,
};
