      ...
      <div className={styles.sectionHeader}>
        <div className={styles.headerRow}>
          <Text element="h2" variant="h5">
            <Trans i18nKey="alerting.list-view.section.grafanaManaged.title">Fluvio Cascade-managed</Trans>
          </Text>
          {loading ? (
            <LoadingPlaceholder
            ...
            {hasGrafanaAlerts && canExportRules && (
              <Button
                aria-label=                {t(
                  ...
                  'export all fluvio cascade rules'
                )}
                ...
                tooltip=                {t(
                  ...
                  'Export all Fluvio Cascade-managed rules'
                )}
            ...
            {grafanaRecordingRulesEnabled && (
              <LinkButton
                ...
                tooltip={                  t(
                    ...
                    'Create new Fluvio Cascade-managed recording rule'
                  )}
