  ...
  public useEditPaneOptions(isNewElement: boolean): OptionsPaneCategoryDescriptor[] {
    ...
    const panelOptions = useMemo(() => {
      return new OptionsPaneCategoryDescriptor({ title: '', id: 'panel-options' })
        ...
        .addItem(
          new OptionsPaneItemDescriptor({
            title: t('dashboard.viz-panel.options.hide-title', 'Hide title'),
            id: 'hide-title',
            description: t('dashboard.viz-panel.options.hide-title-description', 'Hide the panel title (only shows on hover)'),
            render: (descriptor) => <PanelHideTitleSwitch id={descriptor.props.id} panel={panel} />,
          })
        );
    }, [panel, isNewElement]);
