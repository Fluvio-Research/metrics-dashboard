...
export function RowItemRenderer({ model }: SceneComponentProps<RowItem>) {
  const { layout, collapse: isCollapsed, collapsedIcon, fillScreen, hideHeader: isHeaderHidden, isDropTarget, key } = model.useState();
              ...
              >
                ...
                {isCollapsed && collapsedIcon ? (
                  <span className={styles.collapsedIconWrapper}>
                    <img src={collapsedIcon} alt={title || 'Row'} className={styles.collapsedIcon} />
                  </span>
                ) : (
                  <span
                    className={cx(
