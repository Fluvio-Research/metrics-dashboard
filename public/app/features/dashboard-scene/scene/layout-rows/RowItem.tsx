  ...
  implements LayoutParent, BulkActionElement, EditableDashboardElement, DashboardDropTarget
{
  ...
  public onChangeCollapsedIcon(collapsedIcon: string | undefined) {
    this.setState({ collapsedIcon });
  }

  public onChangeRowGroup(rowGroup: string | undefined) {
    this.setState({ rowGroup });
  }
