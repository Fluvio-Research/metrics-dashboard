...
import { CustomPanelExport } from '../panel-share/CustomPanelExport';
...
function getPanelShareView(
  ...
  switch (shareView) {
    case shareDashboardType.link:
      // Use custom panel export for modern UI
      return new CustomPanelExport({ panelRef, onDismiss });
    case shareDashboardType.snapshot:
      return new ShareSnapshot({ dashboardRef, panelRef, onDismiss });
