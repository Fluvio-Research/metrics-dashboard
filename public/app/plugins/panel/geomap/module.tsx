...
export const plugin = new PanelPlugin<Options>(GeomapPanel)
  ...
  .setPanelOptions((builder, context) => {
    ...
    builder
      ...
      .addBooleanSwitch({
        category,
        path: 'controls.hideWhenNoMarkers',
        name: t('geomap.name-hide-when-no-markers', 'Hide when no markers'),
        description: t(
          'geomap.description-hide-when-no-markers',
          'Hide the panel when there are no markers to display'
        ),
        defaultValue: false,
      })
      .addRadio({
