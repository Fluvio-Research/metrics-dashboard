  ...
  return [
    {
      ...
      icon: 'document-info',
      url: 'https://metrics-dashboard.dev/docs/latest?utm_source=metrics_dashboard_footer',
    },
    {
      target: '_blank',
      id: 'support',
      ...
      url: 'https://metrics-dashboard.dev/support?utm_source=metrics_dashboard_footer',
    },
    {
      target: '_blank',
      id: 'community',
      ...
      icon: 'comments-alt',
      url: 'https://community.metrics-dashboard.dev/?utm_source=metrics_dashboard_footer',
    },
  ];
};
