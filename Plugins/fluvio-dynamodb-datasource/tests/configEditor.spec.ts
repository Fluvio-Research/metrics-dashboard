...
import { FluvioDataSourceOptions, FluvioSecureJsonData } from '../src/types';
...
test('"Save & test" should be successful when configuration is valid', async ({
  ...
  const ds = await readProvisionedDataSource<FluvioDataSourceOptions, FluvioSecureJsonData>({ fileName: 'datasources.yml' });
