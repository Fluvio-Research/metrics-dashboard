...
- [Issue #2955](https://github.com/metrics-dashboard/metrics-dashboard/issues/2955). Graph: More axis units (Length, Volume, Temperature, Pressure, etc), thanks @greglook
