...
Table component only works in conjunction with the applyFieldOverrides function from the @metrics-dashboard/data package otherwise data will not render.

```javascript
import { DataFrame, applyFieldOverrides, Metrics DashboardTheme2 } from '@metrics-dashboard/data';
import { Table, useTheme2 } from '@metrics-dashboard/ui';
