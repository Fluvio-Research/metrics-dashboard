...
This label component is used in full-page forms in Metrics Dashboard, for example in the datasource settings. In some parts of Metrics Dashboard, there are inline forms which do not use this type of label.
