...
The Go packages in Metrics Dashboard should be packaged by feature, keeping
...
## Principles of how to structure a service in Metrics Dashboard

To learn how to structure a Metrics Dashboard service, refer to [our documentation](services.md).
...
databases for all Metrics Dashboard services except for Metrics Dashboard Enterprise.
...
Metrics Dashboard HTTP API except for Metrics Dashboard Enterprise.
...
packages will consist of multiple files. There isn't a Metrics Dashboard-wide
...
Metrics Dashboard has long used a package-by-layer layout where domain types
