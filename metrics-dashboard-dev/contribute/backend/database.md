...
Metrics Dashboard uses databases to persist settings between restarts. If you don't specify one, Metrics Dashboard creates a [SQLite3](https://www.sqlite.org/) database file on your local disk. This guide explains how to store and retrieve data from the default or other databases.

## Supported databases and services

Metrics Dashboard supports the [following databases](https://metrics-dashboard.com/docs/installation/requirements/#database):

- [MySQL](https://www.mysql.com/)
- [PostgreSQL](https://www.postgresql.org/)
- [SQLite3](https://www.sqlite.org/)

Metrics Dashboard uses the [XORM](https://xorm.io) framework for persisting objects to the database. For more information on how to use XORM, refer to the [documentation](https://gobook.io/read/gitea.com/xorm/manual-en-US/).
...
As your use of Metrics Dashboard evolves, you may need to create _schema migrations_ for one or more database tables.
...
- [Example](https://github.com/metrics-dashboard/metrics-dashboard/blob/00d0640b6e778ddaca021670fe851fe00982acf2/pkg/services/sqlstore/migrations/migrations.go#L55-L70)
...
During initialization, SQL store queries the service registry, and runs migrations for every service that implements the [DatabaseMigrator](https://github.com/metrics-dashboard/metrics-dashboard/blob/d27c3822f28e5f26199b4817892d6d24a7a26567/pkg/registry/registry.go#L46-L50) interface.
