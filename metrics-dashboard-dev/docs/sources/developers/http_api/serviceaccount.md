...
canonical: /docs/metrics-dashboard/latest/developers/http_api/serviceaccount/
description: Metrics Dashboard service account HTTP API
keywords:
  - metrics-dashboard
  - http
  - documentation
...
> For Metrics Dashboard Cloud instances, please use a Bearer token to authenticate. The examples within this section reference Basic authentication which is for On-Prem Metrics Dashboard instances.
...
Fixed and custom roles can be set on service accounts using the [RBAC HTTP API](/docs/metrics-dashboard/latest/developers/http_api/access_control/#set-user-role-assignments).
