...
canonical: /docs/metrics-dashboard/latest/developers/http_api/folder_dashboard_search/
description: Metrics Dashboard Folder/Dashboard Search HTTP API
keywords:
  - metrics-dashboard
  - http
  - documentation
...
> Note: When using [Role-based access control](/docs/metrics-dashboard/latest/administration/roles-and-permissions/access-control/), search results will contain only dashboards and folders which you have access to.
...
- **dashboardUID** - List of dashboard uid's to search for, It is deprecated since Metrics Dashboard v9.1, please use dashboardUIDs instead
...
[
  {
    ...
    "tags": [],
    "isStarred": false,
    "uri":"db/folder" // deprecated in Metrics Dashboard v5.0
  },
  {
    "id":1,
    "uid": "cIBgcSjkk",
    ...
    "tags":[prod],
    "isStarred":true,
    "uri":"db/production-overview" // deprecated in Metrics Dashboard v5.0
  }
]
```
