...
aliases:
  ...
  - ./external_group_sync/
canonical: /docs/metrics-dashboard/latest/developers/http_api/team_sync/
description: Metrics Dashboard Team Sync HTTP API
keywords:
  - metrics-dashboard
  - http
  - documentation
...
> Team Sync is only available in Metrics Dashboard Enterprise. Read more about [Metrics Dashboard Enterprise](/docs/metrics-dashboard/latest/introduction/metrics-dashboard-enterprise/).
...
[
  {
    "orgId": 1,
    "teamId": 1,
    "groupId": "cn=editors,ou=groups,dc=metrics-dashboard,dc=org"
  }
]
```
...
```http
DELETE /api/teams/1/groups?groupId=cn%3Deditors%2Cou%3Dgroups%2Cdc%3Dmetrics-dashboard%2Cdc%3Dorg HTTP/1.1
Accept: application/json
Content-Type: application/json
Authorization: Bearer glsa_kcVxDhZtu5ISOZIEt
```
