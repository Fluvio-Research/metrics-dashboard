...
- [Tempo](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/datasources/tempo/)
- [Jaeger](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/datasources/jaeger/)
- [Zipkin](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/datasources/zipkin/)
- [X-Ray](https://metrics-dashboard.com/metrics-dashboard/plugins/metrics-dashboard-x-ray-datasource)
- [Azure Monitor](/docs/metrics-dashboard/latest/datasources/azure-monitor/)
- [ClickHouse](https://github.com/metrics-dashboard/clickhouse-datasource)
- [New Relic](/docs/plugins/metrics-dashboard-newrelic-datasource/latest/)
...
- [Introduction to tracing](https://metrics-dashboard.com/docs/tempo/<TEMPO_VERSION>/introduction/)
- [Trace structure](https://metrics-dashboard.com/docs/tempo/<TEMPO_VERSION>/traceql/trace-structure/#trace-structure)
- [Traces and telemetry](https://metrics-dashboard.com/docs/tempo/<TEMPO_VERSION>/introduction/telemetry/)
- [Using traces to find solutions to problems](https://metrics-dashboard.com/docs/tempo/<TEMPO_VERSION>/introduction/solutions-with-traces/)
- [Best practices for tracing](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/datasources/tempo/tracing-best-practices/)

## Query editors

You can query and search tracing data using a data source's query editor. Note that data sources in Metrics Dashboard have unique query editors.
...
Metrics Dashboard's trace view provides an overview of a request as it travels through your system. The following sections provide detail on various elements of the trace view.

{{< figure src="/media/docs/tempo/screenshot-metrics-dashboard-trace-view.png" class="docs-image--no-shadow" max-width= "900px" caption="Trace view" >}}
...
{{< figure src="/media/docs/tempo/screenshot-metrics-dashboard-trace-view-header.png" class="docs-image--no-shadow" max-width= "750px" caption="Trace view header" >}}
...
{{< figure src="/media/docs/tempo/screenshot-metrics-dashboard-trace-view-minimap.png" class="docs-image--no-shadow" max-width= "900px" caption="Trace view minimap example" >}}
...
{{< figure src="/media/docs/tempo/screenshot-metrics-dashboard-trace-view-timeline.png" class="docs-image--no-shadow" max-width= "900px"  caption="Trace view timeline" >}}
...
For more information about spans and traces, refer to [Introduction to tracing](https://metrics-dashboard.com/docs/tempo/latest/introduction/) in the Tempo documentation.
...
{{< figure src="/media/docs/tempo/screenshot-metrics-dashboard-trace-view-span-span-attributes.png" class="docs-image--no-shadow" max-width= "900px"  caption="Trace view span attributes" >}}
...
{{< figure src="/media/docs/tempo/screenshot-metrics-dashboard-trace-view-span-resource-attributes.png" class="docs-image--no-shadow" max-width= "900px"  caption="Trace view span resource attributes" >}}
...
{{< figure src="/media/docs/tempo/screenshot-metrics-dashboard-trace-view-span-events.png" class="docs-image--no-shadow" max-width= "900px"  caption="Trace view span events" >}}
...
Refer to [Span filters](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/datasources/tempo/span-filters/) for more in depth information.

Watch the following video to learn more about filtering trace spans in Metrics Dashboard:
...
{{< figure src="/media/docs/tempo/screenshot-metrics-dashboard-trace-view-trace-to-logs.png" class="docs-image--no-shadow" max-width= "900px" caption="Trace to logs" >}}
...
Refer to each individual data source's documentation for configuration instructions.
For Tempo, refer to [Trace to metrics configuration](https://metrics-dashboard.com/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/datasources/tempo/configure-tempo-data-source/#trace-to-metrics).
...
For Tempo refer to [Trace to profiles](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/datasources/tempo/configure-tempo-data-source#trace-to-profiles) for configuration instructions.
...
You can use [correlations](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/administration/correlations/) to define custom links that appear in the trace view based on trace and span information.

For Tempo, refer to [Trace correlations](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/datasources/tempo/traces-in-metrics-dashboard/trace-correlations/) for configuration instructions.
...
Refer to [Node graph](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/panels-visualizations/visualizations/node-graph/) for additional information.

{{< admonition type="note" >}}
The node graph requires data to be returned from the data source in a specific format to display correctly. Refer to [Data API](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/panels-visualizations/visualizations/node-graph/#data-api), [Nodes data frame structure](/docs/metrics-dashboard/latest/panels-visualizations/visualizations/node-graph/#nodes-data-frame-structure) and [Node graph data requirements](/docs/metrics-dashboard/latest/panels-visualizations/visualizations/node-graph/#data-requirements) for additional information and configuration instructions.
{{< /admonition >}}

{{< figure src="/media/docs/tempo/screenshot-metrics-dashboard-node-graph.png" class="docs-image--no-shadow" max-width= "900px"  caption="Node graph" >}}
...
- [Service Graph and Service Graph view](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/datasources/tempo/service-graph/)
- [Service graph view](/docs/tempo/<TEMPO_VERSION>/metrics-generator/service-graph-view/) in Tempo documentation

{{< figure src="/static/img/docs/metrics-dashboard-cloud/apm-overview.png" class="docs-image--no-shadow" max-width= "900px" caption="Service graph view" >}}
