...
If you set the legend placement to **Right**, the **Width** option becomes available. Leave the field empty to allow Metrics Dashboard to automatically set the legend width or enter a value in the field.
...
![Legend showing values](/media/docs/metrics-dashboard/panels-visualizations/screenshot-legend-values-10.3.png)

## Change a series color

By default, Metrics Dashboard sets the colors of your series data, but you can change them through the panel legend. To change the series data color, follow these steps:
...
Visualizations can often be visually complex, and include many data series. You can simplify the view by removing series data from the visualization through the legend, which isolates the data you want to see. When you do this, Metrics Dashboard automatically creates a new override in the **Override** section.
...
![Legend formatted as a table showing sorted values](/media/docs/metrics-dashboard/panels-visualizations/screenshot-legend-sorted-10.3-v2.png)
