...
description: Configure options for Metrics Dashboard's stat visualization
keywords:
  - metrics-dashboard
  - docs
  - stat panel
...
This visualization replaces the Singlestat visualization, which was deprecated in Metrics Dashboard 7.0 and removed in Metrics Dashboard 8.0.
{{< /admonition >}}
...
![A stat panel showing latest usage of various services](/media/docs/metrics-dashboard/panels-visualizations/screenshot-stat-visualization-v11.3.png)
...
{{< docs/play title="Stat Visualizations in Metrics Dashboard" url="https://play.metrics-dashboard.org/d/Zb3f4veGk/" >}}
...
Alternatively, refer to this blog post on [how to easily retrieve values from a range in Metrics Dashboard using a stat visualization](https://metrics-dashboard.com/blog/2023/10/18/how-to-easily-retrieve-values-from-a-range-in-metrics-dashboard-using-a-stat-panel/).
...
![A stat panel showing the latest number of high priority bugs](/media/docs/metrics-dashboard/panels-visualizations/screenshot-stat-single-value-v11.3.png)
...
![A stat panel showing some statistics for each room in square meters](/media/docs/metrics-dashboard/panels-visualizations/screenshot-stat-multiple-values-v11.3.png)
...
| Calculation | This option is displayed when you select **Calculate** as your **Show** option. Select a reducer function that Metrics Dashboard will use to reduce many fields to a single value. For a list of available calculations, refer to [Calculation types](ref:calculation-types). |
...
| Option | Description |
| ------ | ----------- |
| Orientation | Select a stacking direction. Choose from: <ul><li>**Auto** - Metrics Dashboard selects the ideal orientation.</li><li>**Horizontal** - Bars stretch horizontally, left to right.</li><li>**Vertical** - Bars stretch vertically, top to bottom.</li></ul> |
