...
description: Configure options for Metrics Dashboard's gauge visualization
keywords:
  - metrics-dashboard
  - gauge
  - gauge panel
...
{{< figure src="/media/docs/metrics-dashboard/panels-visualizations/screenshot-gauge-visualization-v11.4.png" alt="A gauge visualization">}}
...
{{< docs/play title="Metrics Dashboard Gauge Visualization" url="https://play.metrics-dashboard.org/d/KIhkVD6Gk/" >}}
...
![Gauge with single numeric value](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.2-gauge-example1.png)
...
![Gauge with single numeric value and hardcoded max and min](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.2-gauge-example2.png)
...
![Gauge visualization with multiple numeric values in a single row](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.2-gauge-example3.png)
...
![Gauge visualization with multiple rows and columns of numeric values showing the last row](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.2-gauge-example6.png)
...
![Gauge visualization with multiple rows and columns of numeric values showing all the values](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.2-gauge-example7.png)
...
![Gauge visualization with numeric values defining max and minimum](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.2-gauge-example4.png)
...
![Gauge visualization with numeric values defining max and minimum but hidden](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.2-gauge-example5.png)
...
| Option | Description |
| ------ | ----------- |
| Show | Set how Metrics Dashboard displays your data. Choose from:<ul><li>**Calculate** - Show a calculated value based on all rows.</li><li>**All values** - Show a separate value for every row. If you select this option, then you can also limit the number of rows to display.</li></ul> |
| Calculation | If you chose **Calculate** as your **Show** option, select a reducer function that Metrics Dashboard will use to reduce many fields to a single value. For a list of available calculations, refer to [Calculation types](ref:calculation-types). |
...
| Gauge size | Choose a gauge size mode:<ul><li>**Auto** - Metrics Dashboard determines the best gauge size.</li><li>**Manual** - Manually configure the gauge size.</li></ul>This option only applies when **Orientation** is set to **Horizontal** or **Vertical**. |
...
![Gauge viz with multiple rows and columns of numeric values showing all the values and thresholds defined for 0-6-11](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.2-gauge-example8.png)
...
{{< docs/shared lookup="visualizations/datalink-options-1.md" source="metrics-dashboard" version="<METRICS_DASHBOARD_VERSION>" >}}
