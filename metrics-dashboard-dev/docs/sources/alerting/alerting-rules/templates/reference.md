---
canonical: https://metrics-dashboard.com/docs/metrics-dashboard/latest/alerting/alerting-rules/templates/reference/
description: Reference for variables and functions in Metrics Dashboard alert rule templating.
keywords:
  - metrics-dashboard
  - alerting
  - templating
...
refs:
  ...
  print-all-labels-from-a-classic-condition:
    - pattern: /docs/metrics-dashboard/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/alerting/alerting-rules/templates/examples/#print-all-labels-from-a-classic-condition
    - pattern: /docs/metrics-dashboard-cloud/
      destination: /docs/metrics-dashboard-cloud/alerting-and-irm/alerting/alerting-rules/templates/examples/#print-all-labels-from-a-classic-condition
...
| [externalURL](#externalurl) | none          | string                 | Returns the external URL of the Metrics Dashboard server as configured in the ini file(s). |
| [pathPrefix](#pathprefix)   | none          | string                 | Returns the path of the Metrics Dashboard server as configured in the ini file(s).         |

For further context on these functions, note that templating in Metrics Dashboard is based on the [Prometheus template implementation](https://prometheus.io/docs/prometheus/latest/configuration/template_reference/), enabling the use of these functions and Prometheus-like templates for formatting alert messages within Metrics Dashboard.
...
The `externalURL` function returns the external URL of the Metrics Dashboard server as configured in the ini file(s):
...
The `pathPrefix` function returns the path of the Metrics Dashboard server as configured in the ini file(s):
