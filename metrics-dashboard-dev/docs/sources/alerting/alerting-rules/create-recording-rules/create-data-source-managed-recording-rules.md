---
canonical: https://metrics-dashboard.com/docs/metrics-dashboard/latest/alerting/alerting-rules/create-recording-rules/create-data-source-managed-recording-rules/
...
- Verify that you have write permission to the Prometheus or Loki data source. Otherwise, you will not be able to create or update Metrics Dashboard Mimir managed alerting rules.

- For Metrics Dashboard Mimir and Loki data sources, enable the ruler API by configuring their respective services.
