...
To detect when a specific target has disappeared, see below **Evict alert instances for missing series** for details on how Metrics Dashboard handles this case and how to set up detection.
