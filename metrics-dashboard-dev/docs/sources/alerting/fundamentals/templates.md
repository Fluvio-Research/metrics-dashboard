---
aliases:
  - ../fundamentals/notifications/templates/ # /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/alerting/fundamentals/templates/
  - ../contact-points/message-templating/ # /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/alerting/contact-points/message-templating/
  - ../alert-rules/message-templating/ # /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/alerting/alert-rules/message-templating/
  - ../unified-alerting/message-templating/ # /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/alerting/unified-alerting/message-templating/
canonical: https://metrics-dashboard.com/docs/metrics-dashboard/latest/alerting/fundamentals/templates/
...
In Metrics Dashboard, you have various options to template your alert notification messages:
...
When creating an alert rule, Metrics Dashboard suggests several optional annotations, such as `description`, `summary`, and `runbook_url`, which help identify and respond to alerts. You can also create custom annotations.
...
Implement annotations that provide meaningful information to respond to your alerts. Annotations are displayed in the Metrics Dashboard alert detail view and are included by default in notifications.
