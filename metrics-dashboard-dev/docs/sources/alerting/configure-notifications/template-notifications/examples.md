...
refs:
  ...
  custom-payload-webhook:
    - pattern: /docs/metrics-dashboard/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/alerting/configure-notifications/manage-contact-points/integrations/webhook-notifier/#custom-payload
    - pattern: /docs/metrics-dashboard-cloud/
      destination: /docs/metrics-dashboard-cloud/alerting-and-irm/alerting/configure-notifications/manage-contact-points/integrations/webhook-notifier/#custom-payload
---
...
1 firing alert(s)
Common labels: 2
- metrics-dashboard_folder = server_alerts
- team = server_admin
...
## Print URLs for runbook and alert data in Metrics Dashboard

Note that the following example works only for Metrics Dashboard-managed alerts. It displays some [alert data](ref:reference-alert) such as `DashboardURL`, `PanelURL`, and `SilenceURL`, which are exclusive to Metrics Dashboard-managed alerts.
...
The next example is a copy of the default title/subject template used in Metrics Dashboard.
...
```template_output
{
 "alerts": [
  {
   ...
   "labels": {
    ...
    "metrics-dashboard_folder": "Test Folder",
    "instance": "instance1"
   },
 ...
 "message": "**Firing**\n\nValue: B=22, C=1\nLabels:\n - alertname = InstanceDown\n - metrics-dashboard_folder = Test Folder\n - instance = instance1\nAnnotations:\n - summary = Instance instance1 has been down for more than 5 minutes\nSource: http://metrics-dashboard.com/alerting/metrics-dashboard/cdeqmlhvflz40f/view?orgId=1\nSilence: http://localhost:3000/alerting/silence/new?alertmanager=metrics-dashboard\u0026matcher=alertname%3DInstanceDown\u0026matcher=metrics-dashboard_folder%3DTest+Folder\u0026matcher=instance%3Dinstance1\u0026orgId=1\nDashboard: http://localhost:3000/d/dashboard_uid?from=1745227186179\u0026orgId=1\u0026to=1745317189058\nPanel: http://localhost:3000/d/dashboard_uid?from=1745227186179\u0026orgId=1\u0026to=1745317189058\u0026viewPanel=1\n\n\n**Resolved**\n\nValue: B=22, C=1\nLabels:\n - alertname = CpuUsage\n - metrics-dashboard_folder = Test Folder\n - instance = instance1\nAnnotations:\n - summary = CPU usage above 90%\nSource: http://metrics-dashboard.com/alerting/metrics-dashboard/oZSMdGj7z/view?orgId=1\nSilence: http://localhost:3000/alerting/silence/new?alertmanager=metrics-dashboard\u0026matcher=alertname%3DCpuUsage\u0026matcher=metrics-dashboard_folder%3DTest+Folder\u0026matcher=instance%3Dinstance1\u0026orgId=1\nDashboard: http://localhost:3000/d/dashboard_uid?from=1745299186179\u0026orgId=1\u0026to=1745317186179\nPanel: http://localhost:3000/d/dashboard_uid?from=1745299186179\u0026orgId=1\u0026to=1745317186179\u0026viewPanel=1\n",
 "orgId": 1,
