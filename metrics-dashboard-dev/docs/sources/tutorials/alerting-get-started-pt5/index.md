...
tags:
  - intermediate
title: Get started with Metrics Dashboard Alerting - Route alerts using dynamic labels
weight: 66
killercoda:
  title: Get started with Metrics Dashboard Alerting - Route alerts using dynamic labels
  description: Learn how to dynamically route alert notifications.
...
The Get started with Metrics Dashboard Alerting - Dynamic routing tutorial is a continuation of the [Get started with Metrics Dashboard Alerting - Templating](http://www.metrics-dashboard.com/tutorials/alerting-get-started-pt4/) tutorial.
...
- **Interactive learning environment**
  - Alternatively, you can [try out this example in our interactive learning environment](https://killercoda.com/metrics-dashboard-labs/course/metrics-dashboard/alerting-get-started-pt5/). It’s a fully configured environment with all the dependencies already installed.
...
To observe data using the Metrics Dashboard stack, download and run the following files.
...
In this use case, we focus on monitoring the system's CPU, memory, and disk usage as part of a monitoring setup. This example is based on the [Metrics Dashboard Prometheus Alerting Demo](https://github.com/tonypowa/metrics-dashboard-prometheus-alerting-demo), which collects and visualizes system metrics via Prometheus and Metrics Dashboard.

Your team is responsible for ensuring the health of your servers, and you want to leverage advanced alerting features in Metrics Dashboard to:
...
1. **Alert condition** section:
   ...
   {{< figure src="/media/docs/alerting/flask-app-metrics.png" max-width="1200px" caption="Preview of a query returning alert instances in Metrics Dashboard." >}}
...
In this section we add a [templated label based on query value](https://metrics-dashboard.com/docs/metrics-dashboard/latest/alerting/alerting-rules/templates/examples/#based-on-query-value) to map to the notification policies.
...
The template should be flexible enough to capture the target keywords (e.g., prod, staging) by adjusting which label the[`$labels`](https://metrics-dashboard.com/docs/metrics-dashboard/latest/alerting/alerting-rules/templates/reference/#labels) is referencing.
...
## Learn more in [Metrics Dashboard Alerting - Link alerts to visualizations](http://www.metrics-dashboard.com/tutorials/alerting-get-started-pt6/)

<!-- INTERACTIVE ignore START -->

{{< admonition type="tip" >}}

In [Metrics Dashboard Alerting - Link alerts to visualizations](http://www.metrics-dashboard.com/tutorials/alerting-get-started-pt6/) you will create alerts using Prometheus data and link them to your graphs.
...
- Understand how alert routing works in [Get started with Metrics Dashboard Alerting - Alert routing](http://www.metrics-dashboard.com/tutorials/alerting-get-started-pt2/).
- Learn how templating works in [Get started with Metrics Dashboard Alerting - Templating](http://www.metrics-dashboard.com/tutorials/alerting-get-started-pt4/).
  - More [examples on templating labels](https://metrics-dashboard.com/docs/metrics-dashboard/latest/alerting/alerting-rules/templates/examples/).
