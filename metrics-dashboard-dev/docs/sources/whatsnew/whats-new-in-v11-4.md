---
description: Feature and improvement highlights for Metrics Dashboard v11.4
keywords:
  - metrics-dashboard
  - new
  - documentation
...
products:
  ...
  - enterprise
  - oss
title: What's new in Metrics Dashboard v11.4
weight: -46
---
...
# What’s new in Metrics Dashboard v11.4

Welcome to Metrics Dashboard 11.4! This is a special release with one new feature, created in partnership with AWS. We’ve made improvements to Cloudwatch so you can query your logs using two additional query languages: Opensearch PPL and Opensearch SQL. We’ve also updated the querying experience by providing a sample of commonly-used queries, syntax highlighting in the query editor, and auto-completion suggestions for complex queries. Read on to learn more about this new feature.

For even more detail about all the changes in this release, refer to the [changelog](https://github.com/metrics-dashboard/metrics-dashboard/blob/main/CHANGELOG.md). For the specific steps we recommend when you upgrade to v11.4, check out our [Upgrade Guide](https://metrics-dashboard.com/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/upgrade-guide/upgrade-v11.4/).
...
![CloudWatch logs explore query languages drop-down list opened](/media/docs/metrics-dashboard/data-sources/screenshot-awscw-query-languages-v11.4.png)
...
![CloudWatch Logs cheat sheet with help icon highlighted](/media/docs/metrics-dashboard/data-sources/screenshot-cwl-cheat-sheet-v11.4.png)
