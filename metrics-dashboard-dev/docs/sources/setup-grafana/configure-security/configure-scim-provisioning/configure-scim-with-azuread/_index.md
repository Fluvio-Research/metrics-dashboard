---
description: Learn how to configure SCIM provisioning with Azure AD in Metrics Dashboard Enterprise. This guide provides step-by-step instructions for setting up automated user and team management, including enterprise application configuration, service account creation, attribute mapping, and provisioning settings to ensure seamless integration between Azure AD and Metrics Dashboard.
keywords:
  - metrics-dashboard
  - scim
  - azure
...
This guide explains how to configure SCIM provisioning with Azure AD to automate user and team management in Metrics Dashboard.
...
Refer to the [SAML authentication with Azure AD documentation](../../configure-authentication/saml/configure-saml-with-azuread/) for specific instructions on how to configure SAML claims and Metrics Dashboard SAML settings for your Azure AD SCIM setup.
{{< /admonition >}}
...
- Admin access to both Metrics Dashboard and Azure AD
- SCIM feature enabled in Metrics Dashboard

## Configure SCIM in Metrics Dashboard

To enable SCIM provisioning in Metrics Dashboard, create a service account and generate a service account token that will be used to authenticate SCIM requests from Azure AD.
...
Configure the enterprise application in Azure AD to enable automated user and team synchronization with Metrics Dashboard. This involves creating a new application and setting up both authentication and provisioning.
...
- **Secret Token:** Enter the service account token from Metrics Dashboard
...
3. Select the groups to synchronize with Metrics Dashboard
4. Save the changes
