...
To view an example templated dashboard, refer to [Graphite Templated Nested dashboard](https://play.metrics-dashboard.org/d/cvDFGseGz/graphite-templated-nested).
