...
![Use Aggregate by to calculate RED metrics for spans and group by attributes](/media/docs/metrics-dashboard/data-sources/tempo/query-editor/tempo-ds-query-build-aggregate-v11-a.png)
