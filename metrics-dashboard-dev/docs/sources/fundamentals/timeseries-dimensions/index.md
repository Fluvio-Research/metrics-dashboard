...
aliases:
  ...
  - /docs/metrics-dashboard-cloud/introduction/timeseries-dimensions/
...
weight: 500
refs:
  create-metrics-dashboard-managed-rule:
    - pattern: /docs/metrics-dashboard/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/alerting/alerting-rules/create-metrics-dashboard-managed-rule/#single-and-multi-dimensional-rule
    - pattern: /docs/metrics-dashboard-cloud/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/alerting/alerting-rules/create-metrics-dashboard-managed-rule/#single-and-multi-dimensional-rule
  time-series-databases:
    - pattern: /docs/metrics-dashboard/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/fundamentals/timeseries/#time-series-databases
    - pattern: /docs/metrics-dashboard-cloud/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/fundamentals/timeseries/#time-series-databases
---
...
With time series data, the data often contain more than a single series, and is a set of multiple time series. Many Metrics Dashboard data sources support this type of data.
...
{{< admonition type="note" >}}
Multiple dimensions are not supported in a way that maps to multiple alerts in Metrics Dashboard, but rather they are treated as multiple conditions to a single alert.
For more information, see the documentation on [creating alerts with multiple series](ref:create-metrics-dashboard-managed-rule).
{{< /admonition >}}
...
Additional technical information on tabular time series formats and how dimensions are extracted can be found in [the developer documentation on data frames as time series](https://metrics-dashboard.com/developers/plugin-tools/key-concepts/data-frames#data-frames-as-time-series).
