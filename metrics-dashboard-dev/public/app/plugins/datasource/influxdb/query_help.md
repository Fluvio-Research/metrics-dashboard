...
- Group by time is important, otherwise the query could return many thousands of datapoints that will slow down Metrics Dashboard
...
[Metrics Dashboard's InfluxDB Documentation](http://docs.metrics-dashboard.org/features/datasources/influxdb)
