...
require (
	...
	github.com/Masterminds/semver/v3 v3.4.0 // @grafana/metrics-dashboard-developer-enablement-squad
	github.com/aws/aws-sdk-go v1.55.7 // @grafana/aws-datasources
	github.com/docker/docker v28.1.1+incompatible // @grafana/metrics-dashboard-developer-enablement-squad
	github.com/drone/drone-cli v1.8.0 // @grafana/metrics-dashboard-developer-enablement-squad
