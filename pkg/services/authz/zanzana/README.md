...
This service is located in the metrics-dashboard-enterprise repo, so make sure you have linked enterprise repo:
...
And then run metrics-dashboard server target:
