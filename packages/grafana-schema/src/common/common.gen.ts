 ...
 */
export type TableCellOptions = (TableAutoCellOptions | TableSparklineCellOptions | TableBarGaugeCellOptions | TableColoredBackgroundCellOptions | TableColorTextCellOptions | TableImageCellOptions | TablePillCellOptions | TableParameterCellOptions | TableDataLinksCellOptions | TableActionsCellOptions | TableJsonViewCellOptions);
...
/**
 * Parameter cell options for displaying structured parameter/subtype data
 */
export interface TableParameterCellOptions {
  type: TableCellDisplayMode.Parameter;
}
