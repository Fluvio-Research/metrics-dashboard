...
This component is currently used when adding [FieldOverrides](https://metrics-dashboard.com/docs/metrics-dashboard/latest/panels/field-options/) in the panel edit mode.
