  ...
  () => [
    {
      ...
      repository: 'https://github.com/metrics-dashboard/metrics-dashboard',
   }
  ],
  [
    {
      projectName: 'Loki';
      repository: 'https://github.com/metrics-dashboard/loki';
    }
  ],
  []
);
...
const tableData: WithCustomCellData[] = [
  ...
  {
    datasource: 'Loki',
    repo: 'https://github.com/metrics-dashboard/loki',
  },
  {
    datasource: 'Tempo',
    repo: 'https://github.com/metrics-dashboard/tempo',
  },
];
