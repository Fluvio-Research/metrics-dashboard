...
This component is used on dashboards to refresh visualizations. Metrics Dashboard does not do this automatically, queries run on their own schedule according to the panel settings. Metrics Dashboard cancels any pending requests when a new refresh is triggered.
