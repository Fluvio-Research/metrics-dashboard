...
Within Metrics Dashboard, we have two different types of alerts and they can be used depending on the context and content.
...
```jsx
import { AppEvents } from '@metrics-dashboard/data';
import { getAppEvents } from '@metrics-dashboard/runtime';
