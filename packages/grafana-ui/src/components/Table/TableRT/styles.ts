...
export function useTableStyles(theme: GrafanaTheme2, cellHeightOption: TableCellHeight) {
  const borderColor = `var(--gf-table-border-color, ${theme.colors.border.weak})`;
  ...
  const buildCellContainerStyle = (
    ...
    return css({
      ...
      '&:hover': {
        ...
        background: rowStyled ? 'inherit' : (backgroundHover ?? `var(--gf-table-cell-hover-bg, ${theme.colors.background.primary})`),
        zIndex: 1,
        '.cellActions': {
  ...
  return {
    ...
    headerCell: css({
      ...
      display: 'flex',
      alignItems: 'center',
      fontWeight: `var(--gf-table-header-font-weight, ${theme.typography.fontWeightMedium})`,
      backgroundColor: `var(--gf-table-header-bg, transparent)`,
      color: `var(--gf-table-header-text, ${theme.colors.text.primary})`,
    ...
    headerCellLabel: css({
      ...
      '&:hover': {
        ...
        color: `var(--gf-table-header-text, ${theme.colors.text.link})`,
      },
    }),
    ...
    row: css({
      ...
      '&:hover': {
        backgroundColor: `var(--gf-table-row-hover-bg, ${theme.components.table.rowHoverBackground})`,
      },
