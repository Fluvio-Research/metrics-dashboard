...
export function TableNG(props: TableNGProps) {
  ...
  const commonDataGridProps = useMemo(
    ...
    [enableVirtualization, resizeHandler, sortColumns, rowHeight, hasFooter, setSortColumns, onSortByChange, styleOverrides]
  );
      ...
      renderCell: ({ row }) => {
        ...
        return (
          <DataGrid<TableRow, TableSummaryRow>
            {...commonDataGridProps}
            className={clsx(styles.grid, styles.gridNested, className)}
