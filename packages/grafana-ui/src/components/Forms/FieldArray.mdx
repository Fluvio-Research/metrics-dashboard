...
**Note: This component is deprecated and will be removed in the future versions of metrics-dashboard/ui. Use the `useFieldArray` hook from react-hook-form instead.**

### Usage

```jsx
import { Form, FieldArray } from '@metrics-dashboard/ui';
