...
The content of the text should be written according to the [Metrics Dashboard writing style guide](https://metrics-dashboard.com/docs/writers-toolkit/write/style-guide/).
...
<ExampleFrame>
  <Text color="primary" element="p">
    {'If you need more help of how to write in Metrics Dashboard you can go to our '}
    <TextLink href="https://metrics-dashboard.com/docs/writers-toolkit/" external>
      {'Writer’s Toolkit'}
    </TextLink>
  </Text>
</ExampleFrame>
