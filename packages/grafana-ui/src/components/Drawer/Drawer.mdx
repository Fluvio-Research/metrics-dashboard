...
One example of the Drawer in use is in Metrics Dashboard's [panel inspector](https://metrics-dashboard.com/docs/metrics-dashboard/latest/panels/inspect-panel/).

### Usage

```tsx
import { Drawer } from '@metrics-dashboard/ui';
