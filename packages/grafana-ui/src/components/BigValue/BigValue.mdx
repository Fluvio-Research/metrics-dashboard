...
Component for showing a value based on a [DisplayValue](https://github.com/metrics-dashboard/metrics-dashboard/blob/main/packages/metrics-dashboard-data/src/types/displayValue.ts#L5).
...
An example usage is in the [Stat panel](https://metrics-dashboard.com/docs/metrics-dashboard/latest/panels/visualizations/stat-panel/).

```tsx
import { DisplayValue } from '@metrics-dashboard/data';
import {
  BigValue,
  BigValueColorMode,
  BigValueGraphMode,
