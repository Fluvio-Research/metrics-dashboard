...
Metrics Dashboard Labs follows the [Airbnb React/JSX Style Guide](https://github.com/airbnb/javascript/tree/master/react) in matters pertaining to React. This guide provides highlights of the style rules we follow.
...
- Put components and types in `@metrics-dashboard/ui`.
- Put data models and data utilities in `@metrics-dashboard/data`.
- Put runtime services interfaces in `@metrics-dashboard/runtime`.
...
Linting is performed using [@metrics-dashboard/eslint-config](https://github.com/metrics-dashboard/eslint-config-metrics-dashboard).
