...
- **Metrics Dashboard Admin -** Manage organizations, users, and view server-wide settings.
...
In this tutorial, you've configured Metrics Dashboard for an organization:
