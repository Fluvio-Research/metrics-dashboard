...
1. In the edit pane, enter the dashboard title and description.
   ...
   {{< figure src="/media/docs/metrics-dashboard/dashboards/screenshot-new-dashboard-v12.png" max-width="750px" alt="New dashboard" >}}
...
1. In the visualization list, select a visualization type.
   ...
   {{< figure src="/media/docs/metrics-dashboard/dashboards/screenshot-select-visualization-v12.png" max-width="350px" alt="Visualization selector" >}}
...
1. Enter a title and description for your dashboard if you haven't already or have Metrics Dashboard create them using [generative AI features](ref:generative-ai-features).
...
1. To add more panels to the dashboard, click **Back to dashboard** and at the bottom-left corner of the dashboard, click **+ Add panel**.
   ...
   {{< figure src="/media/docs/metrics-dashboard/dashboards/screenshot-add-panel-v12.png" max-width="500px" alt="Add panel button" >}}
...
You can configure Metrics Dashboard to dynamically add panels, rows, or tabs to a dashboard based on the value of that variable.
...
<!-- To see an example of repeating rows, refer to [Dashboard with repeating rows](https://play.metrics-dashboard.org/d/000000153/repeat-rows).
...
{{< figure src="/media/docs/metrics-dashboard/dashboards/screenshot-edit-pane-focus-v12.png" max-width="750px" alt="Dashboard with a panel in focus" >}}
...
{{< figure src="/media/docs/metrics-dashboard/dashboards/screenshot-undo-redo-icons-v12.0.png" max-width="500px" alt="Undo and redo buttons" >}}
...
{{< video-embed src="/media/docs/metrics-dashboard/dashboards/screenrecord-undo-redo-v12.0.mp4" >}}
...
{{< figure src="/media/docs/metrics-dashboard/dashboards/screenshot-dashboard-outline-v12.png" max-width="750px" alt="Dashboard with outline open showing panel in focus" >}}
