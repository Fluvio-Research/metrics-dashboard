...
description: Learn best practices for building and maintaining Metrics Dashboard dashboards
labels:
  products:
    - cloud
    - enterprise
...
title: Metrics Dashboard dashboard best practices
weight: 800
refs:
  text-panel:
  ...
  variable-examples:
    - pattern: /docs/metrics-dashboard/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/dashboards/variables/#examples-of-templates-and-variables
    - pattern: /docs/metrics-dashboard-cloud/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/dashboards/variables/#examples-of-templates-and-variables
...
# Metrics Dashboard dashboard best practices

This section provides information about best practices for intermediate Metrics Dashboard administrators and users about how to build and maintain Metrics Dashboard dashboards.

For more information about the different kinds of dashboards you can create, refer to [Metrics Dashboard dashboards: A complete guide to all the different types you can build](https://metrics-dashboard.com/blog/2022/06/06/metrics-dashboard-dashboards-a-complete-guide-to-all-the-different-types-you-can-build/?pg=webinar-getting-started-with-metrics-dashboard-dashboard-design-amer&plcmt=related-content-1).
...
For more information, refer to Tom Wilkie's blog post [The RED method: How to instrument your services](https://metrics-dashboard.com/blog/2018/08/02/the-red-method-how-to-instrument-your-services).
...
{{< docs/play title="The Four Golden Signals" url="https://play.metrics-dashboard.org/d/000000109/" >}}
...
- Perform experimentation and testing in a separate Metrics Dashboard instance dedicated to that purpose, not your production instance. When a dashboard in the test environment is proven useful, then add that dashboard to your main Metrics Dashboard instance.

## Best practices for creating dashboards

This page outlines some best practices to follow when creating Metrics Dashboard dashboards.
...
<!-- vale Metrics Dashboard.GoogleWill = NO -->
...
<!-- vale Metrics Dashboard.GoogleWill = YES -->
...
Once you have a strategy or design guidelines, write them down to help maintain consistency over time. Check out this [Wikimedia runbook example](https://wikitech.wikimedia.org/wiki/Performance/Runbook/Metrics Dashboard_best_practices).
...
- Metrics Dashboard retrieves data from a data source. A basic understanding of [data sources](ref:data-sources) in general and your specific is important.
- Avoid unnecessary dashboard refreshing to reduce the load on the network or backend. For example, if your data changes every hour, then you don't need to set the dashboard refresh rate to 30 seconds.
- Use the left and right Y-axes when displaying time series with different units or ranges.
- Add documentation to dashboards and panels.
  - To add documentation to a dashboard, add a [Text panel visualization](ref:text-panel-visualization) to the dashboard. Record things like the purpose of the dashboard, useful resource links, and any instructions users might need to interact with the dashboard. Check out this [Wikimedia example](https://metrics-dashboard.wikimedia.org/d/000000066/resourceloader?orgId=1).
...
This page outlines some best practices to follow when managing Metrics Dashboard dashboards.
