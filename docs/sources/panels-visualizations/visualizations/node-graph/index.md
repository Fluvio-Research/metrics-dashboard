...
labels:
  products:
    ...
    - enterprise
    - oss
description: Configure options for Metrics Dashboard's node graph visualization
title: Node graph
weight: 100
---
...
![Node graph visualization](/media/docs/metrics-dashboard/panels-visualizations/screenshot-node-graph-v11.3.png 'Node graph')
...
{{< docs/play title="Node graph panel" url="https://play.metrics-dashboard.org/d/bdodfbi3d57uoe/" >}}
...
If the icon field contains a value, it’s displayed instead of the title and subtitle. For a list of of available icons, refer to [Icons Overview](https://developers.metrics-dashboard.com/ui/latest/index.html?path=/story/docs-overview-icon--icons-overview).
...
There also can be additional links in the context menu that can target either other parts of Metrics Dashboard or any external link.

![Node context menu](/media/docs/metrics-dashboard/panels-visualizations/screenshot-node-links-v11.3.png 'Node context menu')
...
The first data source supporting this visualization is X-Ray data source for its Service map feature. For more information, refer to the [X-Ray plugin documentation](https://metrics-dashboard.com/metrics-dashboard/plugins/metrics-dashboard-x-ray-datasource).
...
![Node graph exploration](/media/docs/metrics-dashboard/panels-visualizations/node-graph-exploration-8.0-2.png 'Node graph exploration')
...
![Node graph grid](/media/docs/metrics-dashboard/panels-visualizations/screenshot-node-graph-grid-v11.3.png 'Node graph grid')
...
![Node graph legend](/media/docs/metrics-dashboard/panels-visualizations/screenshot-node-graph-legend-v11.3.png 'Node graph legend')
...
![Node graph grid to default](/media/docs/metrics-dashboard/panels-visualizations/screenshot-node-graph-view-v11.3.png 'Node graph grid to default')
...
| icon          | string        | Name of the icon to show inside the node instead of the default stats. Only Metrics Dashboard [built in icons](https://developers.metrics-dashboard.com/ui/latest/index.html?path=/story/docs-overview-icon--icons-overview)) are allowed.                                                                                                                                                   |
