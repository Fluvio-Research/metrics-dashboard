...
labels:
  products:
    ...
    - enterprise
    - oss
description: Configure options for Metrics Dashboard's pie chart visualization
title: Pie chart
weight: 100
refs:
  calculation-types:
...
![Pie chart visualizations](/media/docs/metrics-dashboard/panels-visualizations/screenshot-pie-chart-v11.4.png)
...
![Pie chart visualization with multiple values in a single row](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.1-pie-example1.png)
...
![Pie chart visualization with multiple row values showing the last one](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.1-pie-example2.png)
...
![Pie chart visualization with multiple row values showing all values](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.1-pie-example3.png)
...
![Pie chart visualization with multiple rows and columns showing the last one](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.1-pie-example4.png)
...
![Pie chart visualization with multiple rows and columns showing the all values](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.1-pie-example5.png)
...
![Pie chart visualization with multiple rows and columns showing values from one column](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.1-pie-example6.png)
...
![Pie chart types](/media/docs/metrics-dashboard/panels-visualizations/screenshot-pie-chart-types.png)
