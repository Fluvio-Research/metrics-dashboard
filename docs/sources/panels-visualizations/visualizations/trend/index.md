...
labels:
  products:
    ...
    - enterprise
    - oss
description: Configure options for Metrics Dashboard's trend visualization
title: Trend
weight: 100
refs:
...
{{< figure src="/media/docs/metrics-dashboard/screenshot-trend-visualization-v12.0.png" max-width="750px" alt="Trend engine power and torque curves" >}}
