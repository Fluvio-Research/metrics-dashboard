...
description: Configure options for Metrics Dashboard's histogram visualization
keywords:
  - metrics-dashboard
  - docs
  - bar chart
...
After you've created a [dashboard](https://metrics-dashboard.com/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/dashboards/build-dashboards/create-dashboard/), the following video shows you how to configure a histogram visualization:

{{< youtube id="QfJ480j9-KM" >}}

{{< docs/play title="Histogram Examples" url="https://play.metrics-dashboard.org/d/histogram_tests/" >}}
...
- **Scheme** - The selected [color palette](https://metrics-dashboard.com/docs/metrics-dashboard/latest/panels-visualizations/configure-standard-options/#color-scheme) is applied to the histogram bars.
