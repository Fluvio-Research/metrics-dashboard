...
description: Configure options for Metrics Dashboard's state timeline visualization
keywords:
  - metrics-dashboard
  - docs
  - state timeline
...
![A state timeline visualization showing CPU usage](/media/docs/metrics-dashboard/panels-visualizations/screenshot-state-timeline-v11.4.png)
...
If your query results aren't in a table format like the preceding examples, especially for time-series data, you can apply specific [transformations](https://stackoverflow.com/questions/68887416/metrics-dashboard-state-timeline-panel-with-values-states-supplied-by-label) to achieve this.
...
![State timeline with time series](/media/docs/metrics-dashboard/panels-visualizations/screenshot-state-timeline-time-series-v11.4.png)
...
| Option | Description                                                                                     |
| ------ | ----------------------------------------------------------------------------------------------- |
| Merge equal consecutive values  | Controls whether Metrics Dashboard merges identical values if they are next to each other. |
