...
labels:
  products:
    ...
    - enterprise
    - oss
description: Configure options for Metrics Dashboard's time series visualization
title: Time series
...
refs:
  ...
  panel-data-section:
    - pattern: /docs/metrics-dashboard/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/panels-visualizations/panel-editor-overview/#data-section
    - pattern: /docs/metrics-dashboard-cloud/
      destination: /docs/metrics-dashboard-cloud/visualizations/panels-visualizations/panel-editor-overview/#data-section
---

# Time series

Time series visualizations are the default way to show the variations of a set of data values over time. Each data point is matched to a timestamp and this _time series_ is displayed as a graph. The visualization can render series as lines, points, or bars and it's versatile enough to display almost any type of [time-series data](https://metrics-dashboard.com/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/fundamentals/timeseries/).

{{< figure src="/media/docs/metrics-dashboard/panels-visualizations/screenshot-time-series-v12.0.png" max-width="750px" alt="Time series visualization" >}}
...
{{< docs/play title="Time Series Visualizations in Metrics Dashboard" url="https://play.metrics-dashboard.org/d/000000016/" >}}

## Supported data formats

Time series visualizations require time-series data—a sequence of measurements, ordered in time, and formatted as a table—where every row in the table represents one individual measurement at a specific time. Learn more about [time-series data](https://metrics-dashboard.com/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/fundamentals/timeseries/).
...
![Time series line chart with multiple numeric fields](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-11.1-timeseries-example1v2.png 'Time series line chart with multiple numeric fields')
...
![Time series line chart with two datasets](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-11.1-timeseries-example2v2.png 'Time series line chart with two datasets')
...
![Time Series Example with second Data Set offset](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-11.1-timeseries-example3v2.png 'Time Series Example with second Data Set offset')
...
{{< figure src="/media/docs/metrics-dashboard/panels-visualizations/screenshot-fill-below-to-v12.0.png" max-width="600px" alt="Fill below to example" >}}

{{< docs/shared lookup="visualizations/multiple-y-axes.md" source="metrics-dashboard" version="<METRICS_DASHBOARD_VERSION>" leveloffset="+2" >}}
...
{{< docs/shared lookup="visualizations/tooltip-options-2.md" source="metrics-dashboard" version="<METRICS_DASHBOARD_VERSION>" leveloffset="+1">}}

### Legend options

{{< docs/shared lookup="visualizations/legend-options-1.md" source="metrics-dashboard" version="<METRICS_DASHBOARD_VERSION>" leveloffset="+1" >}}

### Axis options

{{< docs/shared lookup="visualizations/axis-options-1.md" source="metrics-dashboard" version="<METRICS_DASHBOARD_VERSION>" leveloffset="+1" >}}
...
{{< docs/shared lookup="visualizations/graph-styles-options.md" source="metrics-dashboard" version="<METRICS_DASHBOARD_VERSION>" >}}
