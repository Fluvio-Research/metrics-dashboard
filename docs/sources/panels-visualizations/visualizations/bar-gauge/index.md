...
description: Configure options for Metrics Dashboard's bar gauge visualization
keywords:
  - metrics-dashboard
  - bar
  - bar gauge
...
Bar gauges simplify your data by reducing every field to a single value. You choose how Metrics Dashboard calculates the reduction. This visualization can show one or more bar gauges depending on how many series, rows, or columns your query returns.
...
{{< docs/play title="Bar Gauge" url="https://play.metrics-dashboard.org/d/vmie2cmWz/" >}}
...
![Bar gauge with single row of data](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.1-bargauge-example1.png)
...
![Bar gauge with single row of data including maximum and minimum](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.1-bargauge-example2.png)
...
![Bar gauge, single row of data with max and min displaying value](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.1-bargauge-example3.png)
...
![Bar gauge with multiple rows of data displaying last row](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.1-bargauge-example4.png)
...
![Bar gauge with multiple rows of data displaying all the values](/media/docs/metrics-dashboard/panels-visualizations/screenshot-metrics-dashboard-12.1-bargauge-example5.png)
...
| Option | Description |
| ------ | ----------- |
| Orientation | Choose a stacking direction:<ul><li>**Auto** - Metrics Dashboard determines the best orientation.</li><li>**Horizontal** - Bars stretch horizontally, left to right.</li><li>**Vertical** - Bars stretch vertically, bottom to top.</li></ul> |
...
| Bar size | Choose a bar size mode:<ul><li>**Auto** - Metrics Dashboard determines the best bar size.</li><li>**Manual** - Manually configure the bar size.</li></ul> |
