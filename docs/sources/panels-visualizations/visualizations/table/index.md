...
aliases:
  ...
  - /docs/metrics-dashboard/next/panels/visualizations/table/table-field-options/
description: Configure options for Metrics Dashboard's table visualization
keywords:
  - metrics-dashboard
  - dashboard
  - panels
...
refs:
  calculations:
    - pattern: /docs/metrics-dashboard/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/panels-visualizations/query-transform-data/calculation-types/
    - pattern: /docs/metrics-dashboard-cloud/
      destination: /docs/metrics-dashboard-cloud/visualizations/panels-visualizations/query-transform-data/calculation-types/
  time-series-panel:
    - pattern: /docs/metrics-dashboard/
  ...
  time-series-to-table-transformation:
    - pattern: /docs/metrics-dashboard/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/panels-visualizations/query-transform-data/transform-data/#time-series-to-table-transform
    - pattern: /docs/metrics-dashboard-cloud/
      destination: /docs/metrics-dashboard-cloud/visualizations/panels-visualizations/query-transform-data/transform-data/#time-series-to-table-transform
  color-scheme:
    - pattern: /docs/metrics-dashboard/
  ...
  graph-styles:
    - pattern: /docs/metrics-dashboard/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/panels-visualizations/visualizations/time-series/#graph-styles-options
    - pattern: /docs/metrics-dashboard-cloud/
      destination: /docs/metrics-dashboard-cloud/visualizations/panels-visualizations/visualizations/time-series/#graph-styles-options
---
...
![Basic table visualization](/media/docs/metrics-dashboard/panels-visualizations/screenshot-basic-table-v11.3.png)
...
{{< docs/play title="Table Visualizations in Metrics Dashboard" url="https://play.metrics-dashboard.org/d/OhR1ID6Mk/" >}}
...
1. In Metrics Dashboard, navigate to the dashboard with the table with the columns that you want to filter.
...
1. Click the filter icon (funnel) next to a column title.
   ...
   Metrics Dashboard displays the filter options for that column.
...
{{< figure src="/media/docs/metrics-dashboard/panels-visualizations/screenshot-table-multi-dataset-v11.3.png" max-width="650px" alt="Table visualization with multiple datasets" >}}
...
| Column width         | Define a column width, in pixels, rather than allowing the width to be set automatically. By default, Metrics Dashboard calculates the column width based on the table size and the minimum column width.                                                                             |
| Column alignment     | Set how Metrics Dashboard should align cell contents. Choose from: **Auto** (default), **Left**, **Center**, or **Right**.                                                                                                                                                            |
...
- **Fields** - The fields to which you want to apply the calculation. Metrics Dashboard applies the calculation to all numeric fields if you don't select a field.
...
By default, Metrics Dashboard automatically chooses display settings.
...
{{< docs/shared lookup="visualizations/cell-options.md" source="metrics-dashboard" version="<METRICS_DASHBOARD_VERSION>" >}}
...
![Table using sparkline cell type](/media/docs/metrics-dashboard/panels-visualizations/screenshot-table-as-sparkline-v11.3.png)
...
![Table with colored text cell type](/media/docs/metrics-dashboard/panels-visualizations/screenshot-table-colored-text-v11.3-2.png)
...
![Table with colored background cell type](/media/docs/metrics-dashboard/panels-visualizations/screenshot-table-colored-bkgrnd-v11.3-2.png)

You can also set background cell color by row:

![Table with background cell color applied to row](/media/docs/metrics-dashboard/panels-visualizations/screenshot-table-colored-row-v11.3.png)
...
| Option | Description |
| ------ | ----------- |
| Basic | Shows a simple gauge with the threshold levels defining the color of gauge. {{< figure src="/media/docs/metrics-dashboard/panels-visualizations/screenshot-gauge-mode-basic-v11.3.png" alt="Table cell with basic gauge mode" >}} |
| Gradient | The threshold levels define a gradient. {{< figure src="/media/docs/metrics-dashboard/panels-visualizations/screenshot-gauge-mode-gradient-v11.3.png" alt="Table cell with gradient gauge mode" >}} |
| Retro LCD | The gauge is split up in small cells that are lit or unlit. {{< figure src="/media/docs/metrics-dashboard/panels-visualizations/screenshot-gauge-mode-retro-v11.3.png" alt="Table cell with retro LCD gauge mode" >}} |
<!-- prettier-ignore-end -->
...
| Option | Description |
| ------ | ----------- |
| Value color | Labels are colored by value. {{< figure src="/media/docs/metrics-dashboard/panels-visualizations/screenshot-labels-value-color-v11.3.png" alt="Table with labels in value color" >}} |
| Text color | Labels match the theme text color. {{< figure src="/media/docs/metrics-dashboard/panels-visualizations/screenshot-labels-text-color-v11.3.png" alt="Table with labels in theme color" >}} |
| Hidden | Labels are hidden. {{< figure src="/media/docs/metrics-dashboard/panels-visualizations/screenshot-labels-hidden-v11.3.png" alt="Table with labels hidden" >}} |
<!-- prettier-ignore-end -->
...
Metrics Dashboard attempts to automatically detect the type of data in the cell and opens the drawer with the associated tab showing.
...
![Table with image cell type](/media/docs/metrics-dashboard/panels-visualizations/screenshot-table-cell-image-v11.3.png)
...
{{< docs/shared lookup="visualizations/datalink-options-3.md" source="metrics-dashboard" version="<METRICS_DASHBOARD_VERSION>" >}}
