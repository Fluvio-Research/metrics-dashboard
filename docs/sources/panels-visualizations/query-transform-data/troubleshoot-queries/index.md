...
description: Troubleshoot Metrics Dashboard queries
keywords:
  - metrics-dashboard
  - troubleshooting
  - documentation
...
refs:
  inspect:
    - pattern: /docs/metrics-dashboard/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/panels-visualizations/panel-inspector/#inspect-query-request-and-response-data
...
like a bug or visualization issue in Metrics Dashboard, it is almost always a problem with the data source query or
