---
aliases:
  - ../../panels/calculation-types/ # /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/panels/calculation-types/
  - ../../panels/calculations-list/ # /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/panels/calculations-list/
  - ../../panels/reference-calculation-types/ # /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/panels/reference-calculation-types/
  - ../calculation-types/ # /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/panels-visualizations/calculation-types/
labels:
  products:
    - cloud
    - enterprise
...
The following table contains a list of calculations you can perform in Metrics Dashboard. You can find these calculations in the **Transform** tab and in the bar gauge, gauge, and stat visualizations.
