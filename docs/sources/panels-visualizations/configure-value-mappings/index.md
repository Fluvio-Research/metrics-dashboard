...
![Value mappings applied to a gauge visualization](/media/docs/metrics-dashboard/panels-visualizations/screenshot-value-mappings-v10.4.png)

Value mappings bypass unit formatting set in the **Standard options** section of panel editor, like color or number of decimal places displayed. When value mappings are present in a panel, Metrics Dashboard displays a summary of them in the **Value mappings** section of the editor panel.
...
Metrics Dashboard supports the following value mapping types:
...
![The value 10 mapped to the text Perfection!](/media/docs/metrics-dashboard/panels-visualizations/screenshot-map-value-v10.4.png)
...
![Ranges of numbers mapped to the text Low and High with colors yellow and red](/media/docs/metrics-dashboard/panels-visualizations/screenshot-map-range-v10.4.png)

### Regex

A **Regex** mapping maps regular expressions to text and a color. For example, if a value is `www.example.com`, you can configure a regular expression value mapping so that Metrics Dashboard displays **www** and truncates the domain. Use the **Regex** mapping when you want to format the text and color of a regular expression value.
![A regular expression used to truncate full URLs to the text wwww](/media/docs/metrics-dashboard/panels-visualizations/screenshot-map-regex-v10.4.png)
...
![The value null mapped to the text N/A](/media/docs/metrics-dashboard/panels-visualizations/screenshot-map-special-v10.4.png)
