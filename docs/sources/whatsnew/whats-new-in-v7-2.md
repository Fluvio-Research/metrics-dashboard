...
You can now customize how dates are formatted in Metrics Dashboard. Custom date formats apply to the time range picker, graphs, and other panel visualizations.
