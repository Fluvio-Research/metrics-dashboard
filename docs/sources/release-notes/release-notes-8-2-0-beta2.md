...
labels:
  products:
    ...
    - enterprise
    - oss
title: Release notes for Metrics Dashboard 8.2.0-beta2
---

<!-- Auto generated by update changelog github action -->

# Release notes for Metrics Dashboard 8.2.0-beta2
...
- Add fiscal years and search to time picker. [#39073](https://github.com/metrics-dashboard/metrics-dashboard/pull/39073), [@oscarkilhed](https://github.com/oscarkilhed)
