...
labels:
  products:
    ...
    - enterprise
    - oss
title: Release notes for Metrics Dashboard 7.3.0
---

<!-- Auto generated do not edit -->

# Release notes for Metrics Dashboard 7.3.0
...
- **Auth**: Add SigV4 auth option to data sources. [#27552](https://github.com/metrics-dashboard/metrics-dashboard/pull/27552), [@wbrowne](https://github.com/wbrowne)
