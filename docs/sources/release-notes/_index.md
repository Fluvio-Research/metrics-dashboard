...
As of Metrics Dashboard v9.2 we no longer publish release notes, which are redundant with other release lists that we publish:

- For details about new features, deprecations, and breaking changes in new Metrics Dashboard releases, see [What's New in Metrics Dashboard](../whatsnew/).
- For lists of changes to Metrics Dashboard, with links to pull requests and related issues when available, see the [Changelog](https://github.com/metrics-dashboard/metrics-dashboard/blob/main/CHANGELOG.md).
