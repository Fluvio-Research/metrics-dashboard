...
You can enable debug log messages for RBAC in the Metrics Dashboard configuration file. Debug logs are added to the Metrics Dashboard server logs.
...
You can enable auditing in the Metrics Dashboard configuration file.
...
Learn more about [access control audit logs](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/setup-metrics-dashboard/configure-security/audit-metrics-dashboard/#access-control).

## Missing dashboard, folder or data source permissions

[Dashboard and folder permissions](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/administration/roles-and-permissions/#dashboard-permissions) and [data source permissions](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/administration/roles-and-permissions/#data-source-permissions) can go out of sync if a Metrics Dashboard instance version is upgraded, downgraded and then upgraded again.
...
1. run the following SQL queries
   ...
   ```
1. restart your Metrics Dashboard instance
