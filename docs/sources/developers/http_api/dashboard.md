...
aliases:
  - ../../http_api/dashboard/
canonical: /docs/metrics-dashboard/latest/developers/http_api/dashboard/
description: Metrics Dashboard Dashboard HTTP API
keywords:
  - metrics-dashboard
  - http
  - documentation
...
> To view more about the new API structure, refer to [API overview](https://metrics-dashboard.com/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/developers/http_api/apis/).

## Create Dashboard

`POST /apis/dashboard.metrics-dashboard.app/v1beta1/namespaces/:namespace/dashboards`

Creates a new dashboard.

- namespace: to read more about the namespace to use, see the [API overview](https://metrics-dashboard.com/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/developers/http_api/apis/).
...
```http
POST /apis/dashboard.metrics-dashboard.app/v1beta1/namespaces/default/dashboards HTTP/1.1
...
- **metadata.name** – The Metrics Dashboard [unique identifier]({{< ref "#identifier-id-vs-unique-identifier-uid" >}}). If you do not want to provide this, set metadata.generateName instead to the prefix you would like for the randomly generated uid (cannot be an empty string).
- **metadata.annotations.metrics-dashboard.app/folder** - Optional field, the unique identifier of the folder under which the dashboard should be created.
...

{
  ...
  "metadata": {
    ...
    "labels": {
      "metrics-dashboard.app/deprecatedInternalID": "11"
    },
    "annotations": {
      "metrics-dashboard.app/createdBy": "service-account:dejwtrofg77y8d",
      "metrics-dashboard.app/folder": "fef30w4jaxla8b"
    },
    "managedFields": [
      {
        "manager": "curl",
        "operation": "Update",
        "apiVersion": "dashboard.metrics-dashboard.app/v0alpha1",
...
`PUT /apis/dashboard.metrics-dashboard.app/v1beta1/namespaces/:namespace/dashboards/:uid`
...
```http
POST /apis/dashboard.metrics-dashboard.app/v1beta1/namespaces/default/dashboards/gdxccn HTTP/1.1
Accept: application/json
Content-Type: application/json
Authorization: Bearer eyJrIjoiT0tTcG1pUlY2RnVKZTFVaDFsNFZXdE9ZWmNrMkZYbk

{
  "metadata": {
    ...
    "annotations": {
      "metrics-dashboard.app/folder": "fef30w4jaxla8b",
      "metrics-dashboard.app/message": "commit message"
    },
  },
  "spec": {
...
- **metadata.annotations.metrics-dashboard.app/folder** - Optional field, the unique identifier of the folder under which the dashboard should be created.
- **metadata.annotations.metrics-dashboard.app/message** - Optional field, to set a commit message for the version history.
- **spec** – The dashboard json.
...

{
  ...
  "metadata": {
    ...
    "annotations": {
      ...
      "metrics-dashboard.app/updatedTimestamp": "2025-03-07T02:58:36Z"
    }
  },
  "spec": {
    "schemaVersion": 41,
...
`GET /apis/dashboard.metrics-dashboard.app/v1beta1/namespaces/:namespace/dashboards/:uid`
...
```http
GET /apis/dashboard.metrics-dashboard.app/v1beta1/namespaces/default/dashboards/gdxccn HTTP/1.1
Accept: application/json
Content-Type: application/json
Authorization: Bearer eyJrIjoiT0tTcG1pUlY2RnVKZTFVaDFsNFZXdE9ZWmNrMkZYbk
```
...
`GET /apis/dashboard.metrics-dashboard.app/v1beta1/namespaces/:namespace/dashboards`
...
```http
GET /apis/dashboard.metrics-dashboard.app/v1beta1/namespaces/default/dashboards?limit=1 HTTP/1.1
Accept: application/json
Content-Type: application/json
Authorization: Bearer eyJrIjoiT0tTcG1pUlY2RnVKZTFVaDFsNFZXdE9ZWmNrMkZYbk
```
...
{
  "kind": "DashboardList",
  "apiVersion": "dashboard.metrics-dashboard.app/v1alpha1",
  "metadata": {
  ...
  "items": [
    {
      ...
      "metadata": {
        ...
        "annotations": {
          "metrics-dashboard.app/createdBy": "service-account:cef2t2rfm73lsb",
          "metrics-dashboard.app/updatedBy": "service-account:cef2t2rfm73lsb",
          "metrics-dashboard.app/updatedTimestamp": "2025-03-06T19:50:30Z"
        }
      },
      "spec": {
        "schemaVersion": 41,
...
`DELETE /apis/dashboard.metrics-dashboard.app/v1beta1/namespaces/:namespace/dashboards/:uid`
...
```http
DELETE /apis/dashboard.metrics-dashboard.app/v1beta1/namespaces/default/dashboards/gdxccn HTTP/1.1
Accept: application/json
Content-Type: application/json
Authorization: Bearer eyJrIjoiT0tTcG1pUlY2RnVKZTFVaDFsNFZXdE9ZWmNrMkZYbk
```
...

{
  ...
  "details": {
    "name": "gdxccn",
    "group": "dashboard.metrics-dashboard.app",
    "kind": "dashboards",
    "uid": "Cc7fA5ffHY94NnHZyMxXvFlpFtOmkK3qkBcVZPKSPXcX"
  }
}
...
dashboards and when syncing dashboards between multiple Metrics Dashboard installs, see [dashboard provisioning](/docs/metrics-dashboard/latest/administration/provisioning/#dashboards)
...
- **dashboard.refresh** - Set the dashboard refresh interval. If this is lower than [the minimum refresh interval](/docs/metrics-dashboard/latest/setup-metrics-dashboard/configure-metrics-dashboard/#min_refresh_interval), then Metrics Dashboard will ignore it and will enforce the minimum refresh interval.
...

{
  ...
  "meta": {
    ...
    "folderId": 2,
    "folderUid": "l3KqBxCMz",
    "slug": "production-overview" //deprecated in Metrics Dashboard v5.0
  }
}
```
