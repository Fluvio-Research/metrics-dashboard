...
aliases:
  - ../../http_api/admin/
canonical: /docs/metrics-dashboard/latest/developers/http_api/admin/
description: Metrics Dashboard Admin HTTP API
keywords:
  - metrics-dashboard
  - http
  - documentation
...
> If you are running Metrics Dashboard Enterprise, for some endpoints you'll need to have specific permissions. Refer to [Role-based access control permissions](../../../administration/roles-and-permissions/access-control/custom-role-actions-scopes/) for more information.

## Fetch settings

`GET /api/admin/settings`

Only works with Basic Authentication (username and password). See [introduction](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/http_api/admin/#admin-api) for an explanation.
...

{
  ...
  "paths":{
    "data":"/tsdb/metrics-dashboard",
    "logs":"/logs/apps/metrics-dashboard"},
    "security":{
    "admin_password":"************",
    "admin_user":"admin",
    "cookie_remember_name":"metrics-dashboard_remember",
    "cookie_username":"metrics-dashboard_user",
  ...
  "session":{
    "cookie_name":"metrics-dashboard_sess",
    "cookie_secure":"false",
    "gc_interval_time":"",
    "provider":"file",
  ...
  "smtp":{
    "cert_file":"",
    "enabled":"false",
    "from_address":"admin@metrics-dashboard.localhost",
    "from_name":"Metrics Dashboard",
...
Available in Metrics Dashboard Enterprise v8.0+.
{{< /admonition >}}
...
## Metrics Dashboard Usage Report preview
...
Create new user. Only works with Basic Authentication (username and password). See [introduction](/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/http_api/admin/#admin-api) for an explanation.
...
Note that `OrgId` is an optional parameter that can be used to assign a new user to a different organization when [auto_assign_org](../../../setup-metrics-dashboard/configure-metrics-dashboard/#auto-assign-org) is set to `true`.
...
[Rotates](../../../setup-metrics-dashboard/configure-security/configure-database-encryption/#rotate-data-keys) data encryption keys.
...
[Re-encrypts](../../../setup-metrics-dashboard/configure-security/configure-database-encryption/#re-encrypt-data-keys) data encryption keys.
...
[Re-encrypts](../../../setup-metrics-dashboard/configure-security/configure-database-encryption/#re-encrypt-secrets) secrets.
...
[Rolls back](../../../setup-metrics-dashboard/configure-security/configure-database-encryption/#roll-back-secrets) secrets.
