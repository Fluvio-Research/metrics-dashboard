...
canonical: /docs/metrics-dashboard/latest/developers/http_api/org/
description: Metrics Dashboard Organization HTTP API
keywords:
  - metrics-dashboard
  - http
  - documentation
...
Mainly used by Metrics Dashboard UI for providing list of users when adding team members and
