...
aliases:
  - ../../http_api/snapshot/
canonical: /docs/metrics-dashboard/latest/developers/http_api/snapshot/
...
When creating a snapshot using the API, you have to provide the full dashboard payload including the snapshot data. This endpoint is designed for the Metrics Dashboard UI.
{{< /admonition >}}
