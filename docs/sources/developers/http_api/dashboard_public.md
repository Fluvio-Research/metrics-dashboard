...
canonical: /docs/metrics-dashboard/latest/developers/http_api/dashboard_public/
description: Metrics Dashboard Shared Dashboards HTTP API
keywords:
  - metrics-dashboard
  - http
  - documentation
...
If you're running Metrics Dashboard Enterprise, you'll need to have specific permissions for some endpoints. Refer to [Role-based access control permissions](ref:role-based-access-control-permissions) for more information.
