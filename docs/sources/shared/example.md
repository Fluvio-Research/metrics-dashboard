...
```
\{{< docs/shared lookup="example.md" source="metrics-dashboard" version="<METRICS_DASHBOARD VERSION>" >}}
```
...
{{< docs/list >}}
{{< docs/shared lookup="test.md" source="metrics-dashboard" version="<METRICS_DASHBOARD VERSION>" >}}
