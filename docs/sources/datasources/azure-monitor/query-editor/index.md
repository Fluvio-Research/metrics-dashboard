...
refs:
  query-transform-data-query-options:
    - pattern: /docs/metrics-dashboard/
      destination: /docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/panels-visualizations/query-transform-data/#query-options
...
1. In a Metrics Dashboard panel, select the **Azure Monitor** data source.
...
1. Specify a custom time grain. By default, Metrics Dashboard selects a time grain interval for you based on your selected time range.
...
Metrics Dashboard can display and filter metrics based on dimension values.
...
You can also augment queries by using [template variables](https://metrics-dashboard.com/docs/metrics-dashboard/<METRICS_DASHBOARD_VERSION>/datasources/azure-monitor/template-variables/).
...
> Specifying `Dashboard` will only make use of the Metrics Dashboard time-range.
...
```kusto
Perf
# $__timeFilter is a special Metrics Dashboard macro that filters the results to the time span of the dashboard
...
To help you write queries, you can use several Metrics Dashboard macros in the `where` clause:
...
| `$__escapeMulti($myVar)`        | Escapes illegal characters in multi-value template variables.<br/>If `$myVar` has the values `'\\metrics-dashboard-vm\Network(eth0)\Total','\\hello!'` as a string, use this to expand it to `@'\\metrics-dashboard-vm\Network(eth0)\Total', @'\\hello!'`.<br/><br/>If using single-value variables, escape the variable inline instead: `@'\$myVar'`.                                                                                                                                                              |
...
Additionally, Metrics Dashboard has the built-in [`$__interval` macro](ref:query-transform-data-query-options), which calculates an interval in seconds.
...
| Macro                           | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `$__timeFilter()`               | Expands to `timestamp ≥ datetime(2018-06-05T18:09:58.907Z) and timestamp ≤ datetime(2018-06-05T20:09:58.907Z)`, where the from and to datetimes are from the Metrics Dashboard time picker.                                                                                                                                                                                                                                                                                                                 |
| `$__timeFilter(datetimeColumn)` | Expands to `datetimeColumn ≥ datetime(2018-06-05T18:09:58.907Z) and datetimeColumn ≤ datetime(2018-06-05T20:09:58.907Z)`, where the from and to datetimes are from the Metrics Dashboard time picker.                                                                                                                                                                                                                                                                                                       |
| `$__timeFrom()`                 | Returns the From datetime from the Metrics Dashboard picker.<br/>Example: `datetime(2018-06-05T18:09:58.907Z)`.                                                                                                                                                                                                                                                                                                                                                                                             |
| `$__timeTo()`                   | Returns the To datetime from the Metrics Dashboard picker.<br/>Example: `datetime(2018-06-05T20:09:58.907Z)`.                                                                                                                                                                                                                                                                                                                                                                                               |
| `$__escapeMulti($myVar)`        | Escapes illegal characters from multi-value template variables.<br/>If `$myVar` has the values `'\\metrics-dashboard-vm\Network(eth0)\Total','\\hello!'` as a string, this expands it to `@'\\metrics-dashboard-vm\Network(eth0)\Total', @'\\hello!'`.<br>If you use single-value variables, escape the variable inline instead: `@'\$myVar'`.                                                                                                                                                                        |
