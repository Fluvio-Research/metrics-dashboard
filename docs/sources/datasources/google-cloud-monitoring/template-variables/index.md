...
| **Alignment periods**              | All alignment periods available in the query editor in Metrics Dashboard.       |
...
Use Metrics Dashboard's variable syntax to include variables in queries.
