...
Metrics Dashboard ships with built-in support for [Loki](/docs/loki/latest/), an open-source log aggregation system by Metrics Dashboard Labs. If you are new to Loki the following documentation will help you get started:
...
Use TLS (Transport Layer Security) for an additional layer of security when working with Loki. For information on setting up TLS encryption with Loki see [Metrics Dashboard Loki configuration parameters](/docs/loki/latest/configuration/).
{{< /admonition >}}
...
{{< admonition type="note" >}}
If you use Metrics Dashboard Cloud, you can request modifications to this feature by clicking **Open a Support Ticket** from the Metrics Dashboard Cloud Portal.
{{< /admonition >}}
